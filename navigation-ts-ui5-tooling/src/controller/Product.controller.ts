 ...
 */
 export default class Product extends Controller {
	...
	public filterOnProductId(productIdQuery, productTable, filterCache) {
	...
	public filterOnProductName(productNameQuery, productTable, filterCache) {
